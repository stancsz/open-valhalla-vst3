...
# On macOS, this might use Xcode or Makefiles depending on environment.
# We enforce Release build type.
...
# Zip
cd build/package
zip -r ../../release/FDNR_VST3_Mac.zip .
cd ../..

echo "Build complete: release/FDNR_VST3_Mac.zip"
